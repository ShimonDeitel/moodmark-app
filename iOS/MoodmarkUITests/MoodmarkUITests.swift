...
final class MoodmarkUITests: XCTestCase {
    ...
    func testFreeLimitTriggersPaywall() throws {
        ...
        XCTAssertTrue(app.buttons["unlockProButton"].waitForExistence(timeout: 5) || app.staticTexts["Moodmark Pro"].waitForExistence(timeout: 5))
    }
