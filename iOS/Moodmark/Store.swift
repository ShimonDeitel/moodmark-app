...
final class Store: ObservableObject {
    ...
    /// Free tier allows this many total check-in entries before the paywall appears.
    ...
    init() {
        ...
        entriesURL = support.appendingPathComponent("moodmark_entries.json")
        settingsURL = support.appendingPathComponent("moodmark_settings.json")
        load()
        if entries.isEmpty {
            seed()
        }
